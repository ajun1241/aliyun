...
public class DiscussionMessage extends MessageModel {
   ...
   @Override
    public io.rong.models.message.DiscussionMessage setSenderId(String senderId) {
     ...
     */
    @Override
    public io.rong.models.message.DiscussionMessage setTargetId(String[] targetId) {
        super.setTargetId(targetId);
        return this;
    }

    @Override
    public io.rong.models.message.DiscussionMessage setContent(BaseMessage content) {
        super.setContent(content);
        return this;
    }
    @Override
    public io.rong.models.message.DiscussionMessage setPushContent(String pushContent) {
        super.setPushContent(pushContent);
        return this;
    }
    @Override
    public io.rong.models.message.DiscussionMessage setPushData(String pushData) {
    ...
    public io.rong.models.message.DiscussionMessage setIsPersisted(Integer isPersisted) {
        this.isPersisted = isPersisted;
        return this;
    }
    ...
    public io.rong.models.message.DiscussionMessage setIsCounted(Integer isCounted) {
        this.isCounted = isCounted;
        return this;
    }

    @Override
    public io.rong.models.message.DiscussionMessage setObjectName(String objectName) {
    ...
    public io.rong.models.message.DiscussionMessage setContentAvailable(Integer contentAvailable) {
        this.contentAvailable = contentAvailable;
        return this;
    }
    ...
    public io.rong.models.message.DiscussionMessage setIsIncludeSender(Integer isIncludeSender) {
        this.isIncludeSender = isIncludeSender;
        return this;
    }
}

package com.modcreater.tmchat.rong.example.group.ban;
...
public class BanExample {
        ...
        public static void main(String[] args) throws Exception {
             ...
             * 查询所有设置禁言群方法
             */
            GroupBanResult GroupBanResult = (io.rong.models.response.GroupBanResult)ban.getList();
             ...
             * 检查禁言群方法
             */
            io.rong.models.response.GroupBanResult GroupBanCheckResult = (io.rong.models.response.GroupBanResult)ban.check(groupIds);

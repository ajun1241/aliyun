...
public class RecallMessage {
    ...
    public io.rong.models.message.RecallMessage setSenderId(String senderId) {
        this.senderId = senderId;
        return this;
    }
    ...
    public io.rong.models.message.RecallMessage setTargetId(String targetId) {
        this.targetId = targetId;
        return this;
    }
    ...
    public io.rong.models.message.RecallMessage setuId(String uId) {
        this.uId = uId;
        return this;
    }
    ...
    public io.rong.models.message.RecallMessage setSentTime(String sentTime) {
        this.sentTime = sentTime;
        return this;
    }
}

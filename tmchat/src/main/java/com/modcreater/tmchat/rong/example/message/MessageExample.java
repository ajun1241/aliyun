package com.modcreater.tmchat.rong.example.message;
...
public class MessageExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Reader reader = null ;
        try {
            reader =new BufferedReader( new InputStreamReader(io.rong.example.message.MessageExample.class.getClassLoader().getResourceAsStream("jsonsource/message/TemplateMessage.json")));

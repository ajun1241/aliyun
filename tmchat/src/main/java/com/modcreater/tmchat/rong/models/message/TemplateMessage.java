...
public class TemplateMessage {
     ...
     *
     * */
    private Map<String, io.rong.models.message.TemplateMessage.Data> content;
    ...
    public Map<String, io.rong.models.message.TemplateMessage.Data> getContent() {
        return content;
    }
    /**
     * 设置 content
     */
    public void setContent(Map<String, io.rong.models.message.TemplateMessage.Data> content) {

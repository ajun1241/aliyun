...
public class SystemMessage extends MessageModel {
    ...
    @Override
    public io.rong.models.message.SystemMessage setSenderId(String senderId) {
     ...
     */
    @Override
    public io.rong.models.message.SystemMessage setTargetId(String[] targetId) {
        super.setTargetId(targetId);
        return this;
    }
    @Override
    public io.rong.models.message.SystemMessage setContent(BaseMessage content) {
        super.setContent(content);
        return this;

    }
    @Override
    public io.rong.models.message.SystemMessage setPushContent(String pushContent) {
        super.setPushContent(pushContent);
        return this;
    }
    @Override
    public io.rong.models.message.SystemMessage setPushData(String pushData) {
    ...
    public io.rong.models.message.SystemMessage setIsPersisted(Integer isPersisted) {
        this.isPersisted = isPersisted;
        return this;
    }
    ...
    public io.rong.models.message.SystemMessage setIsCounted(Integer isCounted) {
        this.isCounted = isCounted;
        return this;
    }
    ...
    public io.rong.models.message.SystemMessage setContentAvailable(Integer contentAvailable) {
        this.contentAvailable = contentAvailable;
        return this;
    }
    @Override
    public io.rong.models.message.SystemMessage setObjectName(String objectName) {

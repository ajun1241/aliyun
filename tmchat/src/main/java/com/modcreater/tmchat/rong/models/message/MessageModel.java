...
public class MessageModel {
    ...
    public io.rong.models.message.MessageModel setTargetId(String[] targetId) {
        this.targetId = targetId;
        return this;
    }
    ...
    public io.rong.models.message.MessageModel setObjectName(String objectName) {
        this.objectName = objectName;
        return this;
    }
    ...
    public io.rong.models.message.MessageModel setContent(BaseMessage content) {
        this.content = content;
        return this;
    }
    ...
    public io.rong.models.message.MessageModel setPushContent(String pushContent) {
        this.pushContent = pushContent;
        return this;
    }
    ...
    public io.rong.models.message.MessageModel setPushData(String pushData) {
        this.pushData = pushData;
        return this;
    }
    ...
    public io.rong.models.message.MessageModel setSenderId(String senderId) {
        this.senderId = senderId;
        return this;
    }
}

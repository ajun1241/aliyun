...
public class PrivateMessage extends MessageModel {
    ...
    @Override
    public io.rong.models.message.PrivateMessage setSenderId(String senderId) {
     ...
     */
    @Override
    public io.rong.models.message.PrivateMessage setTargetId(String[] targetId) {
        super.setTargetId(targetId);
        return this;
    }

    @Override
    public io.rong.models.message.PrivateMessage setContent(BaseMessage content) {
         super.setContent(content);
        return this;
    }

    @Override
    public io.rong.models.message.PrivateMessage setPushContent(String pushContent) {
        super.setPushContent(pushContent);
        return this;
    }
    @Override
    public io.rong.models.message.PrivateMessage setPushData(String pushData) {
    ...
    public io.rong.models.message.PrivateMessage setCount(String count) {
        this.count = count;
        return this;
    }
    ...
    public io.rong.models.message.PrivateMessage setVerifyBlacklist(Integer verifyBlacklist) {
        this.verifyBlacklist = verifyBlacklist;
        return this;
    }
    ...
    public io.rong.models.message.PrivateMessage setIsPersisted(Integer isPersisted) {
        this.isPersisted = isPersisted;
        return this;
    }
    ...
    public io.rong.models.message.PrivateMessage setIsCounted(Integer isCounted) {
        this.isCounted = isCounted;
        return this;
    }
    ...
    public io.rong.models.message.PrivateMessage setIsIncludeSender(Integer isIncludeSender) {
        this.isIncludeSender = isIncludeSender;
        return this;
    }
    @Override
    public io.rong.models.message.PrivateMessage setObjectName(String objectName) {
    ...
    public io.rong.models.message.PrivateMessage setContentAvailable(Integer contentAvailable) {
        this.contentAvailable = contentAvailable;
        return this;
    }
